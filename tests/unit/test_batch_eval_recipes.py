...
_EXPECTED_GGUFS = [
    ...
    ("Ornith-1.5-9B-Q4_K_M", "Ornith-1.5-9B-Q4_K_M.gguf"),
    ("Qwen3.8-27B-UD-Q4_K_XL", "Qwen3.8-27B-UD-Q4_K_XL.gguf"),
    ("Ornith-1.5-35B-Q4_K_M", "Ornith-1.5-35B-Q4_K_M.gguf"),
...
_EXPECTED_SPECIAL_FLAGS = {
    ...
    "Ornith-1.5-9B-Q4_K_M": _REASONING_FLAGS,
    "Ornith-1.5-35B-Q4_K_M": _REASONING_FLAGS,
